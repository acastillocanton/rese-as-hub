...
- **PII en `public/help/`**: capturas con comisión (€) y nombres reales de un comercial, servidas sin auth (ya documentado en [public/help/README.md](public/help/README.md)). Opciones: regenerar con cuenta demo, difuminar, o servir tras auth. `robots.txt` + `X-Robots-Tag` reducen la exposición a crawlers pero no la lectura directa por URL.
